...
use k256::{AffinePoint, ProjectivePoint, Scalar, Secp256k1 as K256Curve, U256};
...
impl TecdsaCurve for K256Curve {
    ...
    const HASH_DST: &'static [u8] = b"tecdsa/secp256k1";
    ...
    fn point_from_bytes(bytes: &[u8]) -> tecdsa_core::Result<AffinePoint> {
        let ep = Sec1Point::<K256Curve>::from_bytes(bytes)
