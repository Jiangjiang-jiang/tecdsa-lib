...
/* */
bool
test_CL_HSMqk_ZKAoK (const CL_HSMqk &C, HashAlgo &H, RandGen &randgen,
...
/* */
bool CL_HSMqk_check_all (const CL_HSMqk &C, HashAlgo &H,
...
/* */
bool check (const CL_HSMqk &C, HashAlgo &H, RandGen &randgen,
