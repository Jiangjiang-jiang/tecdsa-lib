...
/* */
void CL_HSMqk_ZKAoK_benchs (const CL_HSMqk &cryptosystem, HashAlgo &H,
...
/* */
template <class Cryptosystem>
void CL_HSMqk_benchs_all (const Cryptosystem &C, HashAlgo &H,
                          RandGen &randgen, const string &pre)
{
...
main (int argc, char *argv[])
{
  ...
  std::cout << "security level | q_nbits | variant |    operation    | "
            << "  time   |  time per op.  | std. dev." << std::endl;
